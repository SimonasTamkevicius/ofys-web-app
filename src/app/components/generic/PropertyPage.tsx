      ...
      {lightboxIndex !== null && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={closeLightbox}
              className="absolute -top-4 -right-4 md:top-4 md:right-4 text-white text-2xl md:text-3xl px-3 py-2 md:px-4 md:py-2 rounded-full bg-black/60 backdrop-blur-sm shadow-lg hover:cursor-pointer hover:text-gray-300 transition-all duration-200 hover:bg-black/80 border border-white/20"
              aria-label="Close"
            >
            ...
            {lightboxIndex !== 0 && (
              <button
                onClick={prevImage}
                className="absolute top-1/2 left-2 md:left-4 -translate-y-1/2 text-white text-3xl md:text-4xl px-3 py-2 md:px-4 md:py-2 rounded-full bg-black/60 backdrop-blur-sm shadow-lg hover:cursor-pointer hover:text-gray-300 transition-all duration-200 hover:bg-black/80 border border-white/20"
            ...
            {lightboxIndex !== galleryImages.length - 1 && (
              <button
                onClick={nextImage}
                className="absolute top-1/2 right-2 md:right-4 -translate-y-1/2 text-white text-3xl md:text-4xl px-3 py-2 md:px-4 md:py-2 rounded-full bg-black/60 backdrop-blur-sm shadow-lg hover:cursor-pointer hover:text-gray-300 transition-all duration-200 hover:bg-black/80 border border-white/20"
            ...
            {/* Image Counter */}
            <div className="absolute top-4 left-1/2 -translate-x-1/2 text-white bg-black/60 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
